...
use App\Views\PortalHRD\Auth\Login;
...
class Auth extends BaseController {
    ...
    public function login()
    {
        ...
        if ($this->auth->check())
		{
			$redirectURL = session('redirect_url') ?? route_to(ViewRoutesContract::PORTALHRD_DASHBOARD);
        ...
        //login
        return TemplateEngine::view(new Login());
    }
	...
	public function attemptLogin()
	{
		...
		{
			return redirect()->route(ViewRoutesContract::PORTALHRD_LOGIN)->withInput()->with('errors', $this->validator->getErrors());
		}
		...
		{
			return redirect()->route(ViewRoutesContract::PORTALHRD_LOGIN)->withInput()->with('error', $this->auth->error() ?? lang('Auth.badAttempt'));
		}
	...
	public function logout()
	{
		...
		return redirect(ViewRoutesContract::PORTALHRD_LOGIN);
	}
