...
use App\Views\PortalHRD\Users\Partials\FormAddPermission;
use App\Views\PortalHRD\ViewRoutesContract;

class PermissionList extends BasePortalView
{
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            ...
                            <a href="#" data-toggle="modal" data-target="#formAddModal" class="btn btn-primary">Add Permission</a>
                            </div><br>
                            <!-- Light table -->
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <?= TemplateEngine::view(new FormAddPermission()) ?>
